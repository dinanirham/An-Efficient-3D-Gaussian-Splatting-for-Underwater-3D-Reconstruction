...
| 4.2b | The reference and the baseline at both fields | 4.2.3 | Ground truth, SS and A0 at a far-field and a near-field crop, one held-out view per scene. Two crops because the far field is medium-dominated and the near field geometry-dominated, which is what separates the two kinds of damage by eye | checkpoints | RENDER |
